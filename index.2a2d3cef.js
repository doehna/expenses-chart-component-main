...
async function fetchJSONData() {
    try {
        const response = await fetch("https://doehna.github.io/expenses-chart-component-main/data.json");
...
function changeWeeksOrder(array, dayId) {
    for(let i = 7; i > dayId; i--)array.splice(0, 0, array.splice(6, 1)[0]);
    return array;
}
...
//# sourceMappingURL=index.2a2d3cef.js.map
